...
[.anns]
== Announcements
* link:asst02.html[Assignment 2] is due on March 5 
* Topic this week: link:#loop[Loops]
* Labs this week will be 40 min code jams. Check out the link:jam1Guide.html[Jam 1 Study Guide] for details!
