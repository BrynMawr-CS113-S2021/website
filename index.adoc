...
[.anns]
== Announcements
* link:asst01.html[Assignment 1] is due on February 26
* Topic this week: link:#if[Booleans and conditionals]
* Labs this week will be informal check-ins over zoom 
* We will have Code Jams in lab next week. Check out the link:jam1Guide.html[Jam 1 Study Guide] for details!
