...
[source]
----
String[] names = {"jeffrey", "lisa", "aline", "0123456789"};
...
However, we recommend you functions match the psuedocode given for `main`.

* `public static void printWelcome()`: Prints the welcome message at the start of the game
* `public static Card[] initCards()`: Creates an array of cards based on names
* `public static void shuffle(Card[] cards)`: Shuffles the cards (changes `cards`)
