...
For each question, test your function from `setup()` using an array of random values 
...
6) No code is executed after a function returns. Therefore, the line `tmp += 1.0` is not executed in 
